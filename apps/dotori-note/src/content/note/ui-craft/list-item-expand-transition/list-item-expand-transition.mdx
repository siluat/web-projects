...
import UiCraftFrame from '@/components/UiCraftFrame.astro';
import { UiCraftSandpack } from '@/components/UiCraftSandpack';
import SquareEnixCopyrightAlert from '@/components/SquareEnixCopyrightAlert.astro';
