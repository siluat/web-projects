...
import { UiCraftSandpack } from '@/entities/note/ui/react/UiCraftSandpack';
import SquareEnixCopyrightAlert from '@/entities/note/ui/SquareEnixCopyrightAlert.astro';

<TimestampBlock recordDate="2025-04-01">
...
<UiCraftSandpack client:load template='react-ts' theme='auto' files={{
  '/App.tsx': {
    code: `
      'use client';
